...
func (_q *CollectionQuery) QueryUser() *UserQuery {
...
func (_q *CollectionQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CollectionQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *CollectionQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *CollectionQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *CollectionQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *CollectionQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CollectionQuery) WithUser(opts ...func(*UserQuery)) *CollectionQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *CollectionQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *User)) error {
...
func (_q *CollectionQuery) ForUpdate(opts ...sql.LockOption) *CollectionQuery {
...
func (_q *CollectionQuery) ForShare(opts ...sql.LockOption) *CollectionQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
