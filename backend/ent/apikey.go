...
func (*APIKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case apikey.FieldID, apikey.FieldUserID, apikey.FieldPermissions:
			values[i] = new(sql.NullInt64)
		case apikey.FieldKeyHash, apikey.FieldKeyPrefix, apikey.FieldName, apikey.FieldStatus:
			values[i] = new(sql.NullString)
		case apikey.FieldLastUsedAt, apikey.FieldExpiresAt, apikey.FieldCreatedAt:
