...
func (_q *TagQuery) QueryAssetTags() *AssetTagQuery {
...
func (_q *TagQuery) WithAssetTags(opts ...func(*AssetTagQuery)) *TagQuery {
	query := (&AssetTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) loadAssetTags(ctx context.Context, query *AssetTagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *AssetTag)) error {
