...
// The AssetTagFunc type is an adapter to allow the use of ordinary
// function as AssetTag mutator.
type AssetTagFunc func(context.Context, *ent.AssetTagMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AssetTagFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AssetTagMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AssetTagMutation", m)
}
...
// The GenerationInputFunc type is an adapter to allow the use of ordinary
// function as GenerationInput mutator.
type GenerationInputFunc func(context.Context, *ent.GenerationInputMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GenerationInputFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GenerationInputMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GenerationInputMutation", m)
}
