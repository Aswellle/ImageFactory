...
func (tc *TagCreate) SetUserID(i int64) *TagCreate {
...
func (tc *TagCreate) AddAssetIDs(ids ...int64) *TagCreate {
	tc.mutation.AddAssetIDs(ids...)
	return tc
}

// AddAssets adds the "assets" edges to the Asset entity.
func (tc *TagCreate) AddAssets(a ...*Asset) *TagCreate {
...
func (tc *TagCreate) AddAssetTagIDs(ids ...int64) *TagCreate {
	tc.mutation.AddAssetTagIDs(ids...)
	return tc
}

// AddAssetTags adds the "asset_tags" edges to the AssetTag entity.
func (tc *TagCreate) AddAssetTags(a ...*AssetTag) *TagCreate {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
func (tc *TagCreate) createSpec() (*Tag, *sqlgraph.CreateSpec) {
	...
	if nodes := tc.mutation.AssetTagsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
