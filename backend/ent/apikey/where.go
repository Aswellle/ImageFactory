...
func Permissions(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldPermissions, v))
}
...
func PermissionsEQ(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldEQ(FieldPermissions, v))
}

// PermissionsNEQ applies the NEQ predicate on the "permissions" field.
func PermissionsNEQ(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldNEQ(FieldPermissions, v))
}

// PermissionsIn applies the In predicate on the "permissions" field.
func PermissionsIn(vs ...int) predicate.APIKey {
	return predicate.APIKey(sql.FieldIn(FieldPermissions, vs...))
}

// PermissionsNotIn applies the NotIn predicate on the "permissions" field.
func PermissionsNotIn(vs ...int) predicate.APIKey {
	return predicate.APIKey(sql.FieldNotIn(FieldPermissions, vs...))
}

// PermissionsGT applies the GT predicate on the "permissions" field.
func PermissionsGT(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldGT(FieldPermissions, v))
}

// PermissionsGTE applies the GTE predicate on the "permissions" field.
func PermissionsGTE(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldGTE(FieldPermissions, v))
}

// PermissionsLT applies the LT predicate on the "permissions" field.
func PermissionsLT(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldLT(FieldPermissions, v))
}

// PermissionsLTE applies the LTE predicate on the "permissions" field.
func PermissionsLTE(v int) predicate.APIKey {
	return predicate.APIKey(sql.FieldLTE(FieldPermissions, v))
}
