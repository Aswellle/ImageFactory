...
func HasAssets() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAssetsWith(preds ...predicate.Asset) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := newAssetsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasGenerationJobs() predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasGenerationJobsWith(preds ...predicate.GenerationJob) predicate.Project {
	return predicate.Project(func(s *sql.Selector) {
