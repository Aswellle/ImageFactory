...
type AccountQuery struct {
	...
	withUsageLogs *UsageRecordQuery
...
func (aq *AccountQuery) QueryUsageLogs() *UsageRecordQuery {
	query := (&UsageRecordClient{config: aq.config}).Query()
...
func (aq *AccountQuery) WithUsageLogs(opts ...func(*UsageRecordQuery)) *AccountQuery {
	query := (&UsageRecordClient{config: aq.config}).Query()
...
func (aq *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := aq.withUsageLogs; query != nil {
		if err := aq.loadUsageLogs(ctx, query, nodes,
			func(n *Account) { n.Edges.UsageLogs = []*UsageRecord{} },
			func(n *Account, e *UsageRecord) { n.Edges.UsageLogs = append(n.Edges.UsageLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AccountQuery) loadUsageLogs(ctx context.Context, query *UsageRecordQuery, nodes []*Account, init func(*Account), assign func(*Account, *UsageRecord)) error {
