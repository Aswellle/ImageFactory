...
func (_q *AccountQuery) QueryUsageLogs() *UsageRecordQuery {
...
func (_q *AccountQuery) WithUsageLogs(opts ...func(*UsageRecordQuery)) *AccountQuery {
	query := (&UsageRecordClient{config: _q.config}).Query()
...
func (_q *AccountQuery) loadUsageLogs(ctx context.Context, query *UsageRecordQuery, nodes []*Account, init func(*Account), assign func(*Account, *UsageRecord)) error {
